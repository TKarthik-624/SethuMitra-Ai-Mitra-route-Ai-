...
class SetuMitraRepository private constructor(context: Context) {
    ...
    companion object {
        @Volatile
        private var instance: SetuMitraRepository? = null

        fun getInstance(context: Context): SetuMitraRepository {
            return instance ?: synchronized(this) {
                instance ?: SetuMitraRepository(context.applicationContext).also { instance = it }
            }
        }
    }
